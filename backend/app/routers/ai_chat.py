...
# tool_rank_sites_by_group moved to app/moby/tools/explorer.py (Phase 2 refactor).



# tool_group_count moved to app/moby/tools/aggregates.py (Phase 2 refactor).



# tool_group_count_agg moved to app/moby/tools/aggregates.py (Phase 2 refactor).



# ==== Salesforce groupers (counts and aggregations) ====

# tool_contacts_by_group moved to app/moby/tools/members.py (Phase 2 refactor).



# tool_qual_search moved to app/moby/tools/aggregates.py (Phase 2 refactor).
