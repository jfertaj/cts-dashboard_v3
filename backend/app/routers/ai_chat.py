...
# _INDEX_CACHE moved to app/moby/knowledge/index.py (Phase 5b refactor).
# Shim re-export so external callers (moby_tools.py, helpers/labels.py) keep working.
from app.moby.knowledge.index import _INDEX_CACHE  # noqa: E402,F401
...
# _normalize, _smart_title, _apply_common_rewrites, _prettify_sf_field_name
# moved to app/moby/knowledge/text.py (Phase 5b refactor).
from app.moby.knowledge.text import (  # noqa: E402,F401
    _normalize,
    _smart_title,
...
# _load_sf_fields, _introspect_site_qual_keys, _introspect_profiling_kv_keys,
# _load_qual_aliases, _build_knowledge_index moved to app/moby/knowledge/index.py
# (Phase 5b refactor). Shim re-exports preserve patch paths.
from app.moby.knowledge.index import (  # noqa: E402,F401
    _load_sf_fields,
    _introspect_site_qual_keys,
    _introspect_profiling_kv_keys,
    _load_qual_aliases,
    _build_knowledge_index,
)


# _format_hints_block, _semantic_field_hints, _top_matches moved to
# app/moby/knowledge/hints.py (Phase 5b refactor). Shim re-exports.
from app.moby.knowledge.hints import (  # noqa: E402,F401
    _format_hints_block,
...
# _extract_structured moved to app/moby/knowledge/parsing.py (Phase 5b refactor).
from app.moby.knowledge.parsing import _extract_structured  # noqa: E402,F401
...
# _describe_fields, _short_circuit_aggregation_lines, _sf_escape_value moved
# to app/moby/helpers/sf.py (Phase 5b refactor). Shim re-exports.
from app.moby.helpers.sf import (  # noqa: E402,F401
    _describe_fields,
    _short_circuit_aggregation_lines,
    _sf_escape_value,
    _AGGREGATION_INTENT_RE,
    _AGGREGATION_TARGETS,
)

# _validate_soql moved to app/moby/helpers/soql.py (Phase 3 refactor).
from app.moby.helpers.soql import _validate_soql  # noqa: F401, E402

# ====== Helpers UI / SOQL ======

# _ensure_soql_has_account_id moved to app/moby/helpers/soql.py (Phase 3 refactor).
from app.moby.helpers.soql import _ensure_soql_has_account_id  # noqa: F401, E402


# _normalize_table_for_ui moved to app/moby/helpers/tables.py (Phase 3 refactor).
from app.moby.helpers.tables import _normalize_table_for_ui  # noqa: F401, E402


# ====== Explorer (drive km) ======
# tool_explorer_within_drive_km moved to app/moby/tools/explorer.py (Phase 2 refactor).
# Re-exported at bottom of file.


# tool_members_search moved to app/moby/tools/members.py (Phase 2 refactor).



# tool_explorer_search moved to app/moby/tools/explorer.py (Phase 2 refactor).


# tool_nearest_filtered_sites moved to app/moby/tools/explorer.py (Phase 2 refactor).
...
# tool_sql_query moved to app/moby/tools/aggregates.py (Phase 2 refactor).


# tool_salesforce_account_contacts moved to app/moby/tools/salesforce.py (Phase 5a refactor).
# tool_salesforce_assignments moved to app/moby/tools/salesforce.py (Phase 5a refactor).
# Re-exported above via shim import.


# ---- Activities / Sites tools ----
# --- Activity tools moved to app/moby/tools/activities.py (Phase 4 refactor) ---
# Re-exported here so external callers (moby_handlers.py, tests) keep working.
from app.moby.tools.activities import (  # noqa: F401
    tool_sites_by_activity,
    tool_sites_with_any_activity,
    tool_list_all_activities,
    tool_activities_with_countries,
    tool_activity_counts_by_country,
    tool_activity_country_matrix,
    tool_activities_with_assignments_counts,
    tool_activity_assignments_detailed,
    tool_activity_sites_by_country,
)


# --- tool_study_coordinators_with_activities moved to app/moby/tools/coordinators.py (Phase 4) ---
from app.moby.tools.coordinators import tool_study_coordinators_with_activities  # noqa: F401


# --- tool_explorer_set_filters + tool_manipulate_data moved to app/moby/tools/manipulation.py (Phase 4) ---
from app.moby.tools.manipulation import (  # noqa: F401
    tool_explorer_set_filters,
    tool_manipulate_data,
)
...
# Re-exported here so external imports (tests, moby_tools.py) keep working.
from app.moby.tools_spec import TOOLS_SPEC  # noqa: E402,F401

# ====== System prompt ======
# SCHEMA_HINT and SYSTEM_PROMPT moved to app/moby/prompt.py (Phase 1 refactor).
# Shim re-exports preserve existing imports. Dynamic prompt builders that depend
# on the knowledge index will move in Phase 3.
from app.moby.prompt import SCHEMA_HINT, SYSTEM_PROMPT  # noqa: F401,E402


# _is_complex_query, _truncate_history moved to app/moby/loop.py (Phase 5b refactor).
from app.moby.loop import _is_complex_query, _truncate_history  # noqa: E402,F401
...
from app.moby.tools.salesforce import (  # noqa: E402,F401
    ...
    tool_salesforce_account_contacts,
    tool_salesforce_assignments,
    tool_group_count_sf,
    tool_group_agg_sf,
    tool_time_series_sf,
    tool_sql_query_fill_sf,
)
# --- Explorer-side tool implementations moved to app/moby/tools/explorer.py (Phase 2 refactor)
from app.moby.tools.explorer import (  # noqa: E402,F401
    tool_explorer_within_drive_km,
    tool_explorer_search,
    tool_nearest_filtered_sites,
    tool_rank_sites_by_group,
)
# --- Members + contacts_by_group moved to app/moby/tools/members.py (Phase 2 refactor)
from app.moby.tools.members import (  # noqa: E402,F401
    tool_members_search,
    tool_contacts_by_group,
)
# --- SQL + aggregate tools moved to app/moby/tools/aggregates.py (Phase 2 refactor)
from app.moby.tools.aggregates import (  # noqa: E402,F401
    tool_sql_query,
    tool_group_count,
    tool_group_count_agg,
    tool_qual_search,
)
...
from app.moby.claude_client import (  # noqa: F401,E402
...
# _dispatch_tool_calls, _agentic_loop moved to app/moby/loop.py (Phase 5b refactor).
from app.moby.loop import _dispatch_tool_calls, _agentic_loop  # noqa: E402,F401

# _detect_lang_hint + _synthesis_fallback moved to app/moby/synthesis.py
# (Phase 1 refactor). Shim re-exports preserve test mock targets.
from app.moby.synthesis import _detect_lang_hint, _synthesis_fallback  # noqa: F401,E402


# _sf_escape_value moved to app/moby/helpers/sf.py (Phase 5b refactor).
...
# _sanitize_soql_basic moved to app/moby/helpers/soql.py (Phase 3 refactor).
...
# --- tool_rank_sites moved to app/moby/tools/ranking.py (Phase 4) ---
from app.moby.tools.ranking import tool_rank_sites  # noqa: F401
